  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed left-1/2 top-1/2 z-50 grid w-full max-w-[calc(100%-1rem)] -translate-x-1/2 -translate-y-1/2 rounded-xl bg-popover text-sm text-popover-foreground ring-1 ring-foreground/10 duration-100 outline-none data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 sm:max-w-sm",
          "max-h-[calc(100dvh-1rem)] overflow-hidden",
          "sm:max-h-[calc(100dvh-2rem)] sm:max-w-sm",
          className,
        )}
        {...props}
      >
        <ScrollArea className="max-h-[calc(100dvh-1rem)] min-h-0 w-full sm:max-h-[calc(100dvh-2rem)]">
